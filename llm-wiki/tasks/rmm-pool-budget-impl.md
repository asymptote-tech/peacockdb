...
- [ ] **Step 1: Print the peak at exit in each of the six**
...
- [ ] **Step 2: Build and run them on the device**
...
- [ ] **Step 4: Revert the six print lines, hand back**
...
- [ ] **Step 1: Change the signature and delete the percentage path from it**
...
- [ ] **Step 2: Keep the percentage constants for the one caller that still needs them**
...
- [ ] **Step 3: Give each binary a named budget beside its `main()`**
...
- [ ] **Step 5: `git clang-format`, append the budget table to the detail file, hand back**
...
- [ ] **Step 1: Add the parameter, keeping the return contract**
...
- [ ] **Step 2: Do not touch `gpu_memory_limit`**
...
- [ ] **Step 3: Build the FFI and run its test**
...
- [ ] **Step 1: The full GPU tier, byte-identical**
...
- [ ] **Step 2: Two at once — the thing this task exists for**
...
- [ ] **Step 3: Record what the pool actually reserved**
...
- [ ] **Step 1: Mark #178 tentatively closed, in place**
...
- [ ] **Step 2: Carry the instruction for whoever meets it next**
...
- [ ] **Step 3: Check the ticket still fits its cap**
...
- [ ] **Step 4: Confirm `prompts.md` already carries the coordinator's half**
...
- [ ] **Step 5: Append and hand back for the completeness pass**
