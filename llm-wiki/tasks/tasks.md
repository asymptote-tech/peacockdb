...
### 1. [`utf8-everywhere.md`](utf8-everywhere.md) — closes [#183](active-tickets.md#t183) — state: rebase needed(completeness approved) — PR #158
...
### 2. [`decimal-precision-at-export.md`](decimal-precision-at-export.md) — closes [#187](active-tickets.md#t187) — state: approved to build
...
### 4. [`date-part-return-type.md`](date-part-return-type.md) — closes [#191](active-tickets.md#t191) — state: approved to build
...
### 5. [`device-schema-harness.md`](device-schema-harness.md) — state: approved to build
