...
| **gpu — `--features gpu`: shad-gpu only. 88 cases: `--lib -- gpu_tests::` 80, `test_gpu_corpus` 8** | | | |
| *crate integration, external* | | | |
