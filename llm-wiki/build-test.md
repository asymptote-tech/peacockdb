...
|---|---|---|--:|
| **cpu — `--features rust-only`: no FFI, no device. 1024 cases: `--lib` 553, `test_cpu_corpus` 448, `test_corpus_goldens` 20, `test_cost_model` 3** | | | |
