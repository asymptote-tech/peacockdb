...
#### cpu — `--features rust-only`: no FFI, no device. 1008 cases: `--lib` 537, `test_cpu_corpus` 448, `test_corpus_goldens` 20, `test_cost_model` 3
