...
| CPU exec bespoke (Rust) | wrapper stripping, routing predicate, instrumented stats, and that the benchmark path names neither a CPU-side golden nor the CPU backend | [test_execution_strips_gpu_nodes](../peacockdb-core/tests/test_cpu_executor_misc.rs#L102) | dataset-matrix | 6 |
