...
| **gpu — `--features gpu`: shad-gpu only. 289 cases: `--lib -- gpu_tests::` 281, `test_gpu_corpus` 8** | | | |
| *crate integration, external* | | | |
