...
operator_case! {
    GpuProject,
    fn a_date_part_year_declares_the_int32_the_device_holds() {
...
operator_case! {
    GpuProject,
    fn a_date_part_month_declares_the_int32_the_device_holds() {
...
operator_case! {
    GpuProject,
    fn a_date_part_day_declares_the_int32_the_device_holds() {
