...
/// Format CPU execution stats as a pre-order tree.
/// Stats are post-order; the plan tree provides the indentation structure.
...
// ── CPU cost canonization ─────────────────────────────────────────────────

fn assert_cpu_matches_canonical_at(plan: &Arc<dyn ExecutionPlan>, stats: &[NodeMemoryStats], name: &str, dir: &std::path::Path) {
    ...
    assert_eq!(
        actual,
        canonical.trim_end(),
        "CPU plan for '{name}' does not match {}",
        canonical_path.display()
    );
}

/// CPU-execute `name` against `data_dir`/`queries_dir` and compare per-node CPU
/// memory stats to the `.cpu.txt` canonical in `canon_dir`. Shared by the TPC-H
/// and TPC-DS CPU-cost test macros.
async fn run_cpu_query_test_at(
    name: &str,
    data_dir: &std::path::Path,
    queries_dir: &std::path::Path,
    canon_dir: &std::path::Path,
    ...
    let exec = CpuExecutor::new(data_dir, TARGET_PARTITIONS, TEST_GPU_MEMORY_BUDGET)
        .await
        .unwrap();
    let (_, plan, stats) = exec.execute_instrumented(&sql).await.unwrap();
    assert_cpu_matches_canonical_at(&plan, &stats, name, canon_dir);
}

/// Define a TPC-H CPU-cost canonical test (testdata/tpch-queries → testdata/plans.sf1).
macro_rules! cpu_plan_test {
    ($func_name:ident, $query_name:literal) => {
        #[tokio::test]
        async fn $func_name() {
            run_cpu_query_test_at(
                $query_name,
                &testdata_dir(),
                &queries_dir(),
                &canondata_dir(),
...
/// Define a TPC-DS CPU-cost canonical test (testdata/tpcds-queries → testdata/plans-tpcds.sf1).
macro_rules! cpu_plan_test_tpcds {
    ($func_name:ident, $query_name:literal) => {
        #[tokio::test]
        async fn $func_name() {
            run_cpu_query_test_at(
...
cpu_plan_test!(cpu_tpch_q1,  "q1");
cpu_plan_test!(cpu_tpch_q2,  "q2");
cpu_plan_test!(cpu_tpch_q4,  "q4");
cpu_plan_test!(cpu_tpch_q7,  "q7");
cpu_plan_test!(cpu_tpch_q8,  "q8");
cpu_plan_test!(cpu_tpch_q9,  "q9");
cpu_plan_test!(cpu_tpch_q11, "q11");
cpu_plan_test!(cpu_tpch_q12, "q12");
cpu_plan_test!(cpu_tpch_q13, "q13");
cpu_plan_test!(cpu_tpch_q14, "q14");
cpu_plan_test!(cpu_tpch_q16, "q16");
cpu_plan_test!(cpu_tpch_q17, "q17");
cpu_plan_test!(cpu_tpch_q18, "q18");
cpu_plan_test!(cpu_tpch_q20, "q20");
cpu_plan_test!(cpu_tpch_q21, "q21");
cpu_plan_test!(cpu_tpch_q22, "q22");

cpu_plan_test_tpcds!(cpu_tpcds_q1,  "q1");
cpu_plan_test_tpcds!(cpu_tpcds_q2,  "q2");
cpu_plan_test_tpcds!(cpu_tpcds_q3,  "q3");
cpu_plan_test_tpcds!(cpu_tpcds_q4,  "q4");
cpu_plan_test_tpcds!(cpu_tpcds_q5,  "q5");
cpu_plan_test_tpcds!(cpu_tpcds_q6,  "q6");
cpu_plan_test_tpcds!(cpu_tpcds_q7,  "q7");
cpu_plan_test_tpcds!(cpu_tpcds_q8,  "q8");
cpu_plan_test_tpcds!(cpu_tpcds_q9,  "q9");
cpu_plan_test_tpcds!(cpu_tpcds_q10, "q10");
cpu_plan_test_tpcds!(cpu_tpcds_q11, "q11");
cpu_plan_test_tpcds!(cpu_tpcds_q12, "q12");
cpu_plan_test_tpcds!(cpu_tpcds_q13, "q13");
cpu_plan_test_tpcds!(cpu_tpcds_q14, "q14");
cpu_plan_test_tpcds!(cpu_tpcds_q15, "q15");
cpu_plan_test_tpcds!(cpu_tpcds_q16, "q16");
cpu_plan_test_tpcds!(cpu_tpcds_q17, "q17");
cpu_plan_test_tpcds!(cpu_tpcds_q18, "q18");
cpu_plan_test_tpcds!(cpu_tpcds_q19, "q19");
cpu_plan_test_tpcds!(cpu_tpcds_q20, "q20");
cpu_plan_test_tpcds!(cpu_tpcds_q21, "q21");
cpu_plan_test_tpcds!(cpu_tpcds_q22, "q22");
cpu_plan_test_tpcds!(cpu_tpcds_q23, "q23");
cpu_plan_test_tpcds!(cpu_tpcds_q24, "q24");
cpu_plan_test_tpcds!(cpu_tpcds_q25, "q25");
cpu_plan_test_tpcds!(cpu_tpcds_q26, "q26");
// q27: skipped (ROLLUP ordering issue — same as query_plan_test)
cpu_plan_test_tpcds!(cpu_tpcds_q28, "q28");
cpu_plan_test_tpcds!(cpu_tpcds_q29, "q29");
cpu_plan_test_tpcds!(cpu_tpcds_q30, "q30");
cpu_plan_test_tpcds!(cpu_tpcds_q31, "q31");
cpu_plan_test_tpcds!(cpu_tpcds_q32, "q32");
cpu_plan_test_tpcds!(cpu_tpcds_q33, "q33");
cpu_plan_test_tpcds!(cpu_tpcds_q34, "q34");
cpu_plan_test_tpcds!(cpu_tpcds_q35, "q35");
cpu_plan_test_tpcds!(cpu_tpcds_q36, "q36");
cpu_plan_test_tpcds!(cpu_tpcds_q37, "q37");
cpu_plan_test_tpcds!(cpu_tpcds_q38, "q38");
cpu_plan_test_tpcds!(cpu_tpcds_q39, "q39");
cpu_plan_test_tpcds!(cpu_tpcds_q40, "q40");
cpu_plan_test_tpcds!(cpu_tpcds_q41, "q41");
cpu_plan_test_tpcds!(cpu_tpcds_q42, "q42");
cpu_plan_test_tpcds!(cpu_tpcds_q43, "q43");
cpu_plan_test_tpcds!(cpu_tpcds_q44, "q44");
cpu_plan_test_tpcds!(cpu_tpcds_q45, "q45");
cpu_plan_test_tpcds!(cpu_tpcds_q46, "q46");
cpu_plan_test_tpcds!(cpu_tpcds_q47, "q47");
cpu_plan_test_tpcds!(cpu_tpcds_q48, "q48");
cpu_plan_test_tpcds!(cpu_tpcds_q49, "q49");
cpu_plan_test_tpcds!(cpu_tpcds_q50, "q50");
cpu_plan_test_tpcds!(cpu_tpcds_q51, "q51");
cpu_plan_test_tpcds!(cpu_tpcds_q52, "q52");
cpu_plan_test_tpcds!(cpu_tpcds_q53, "q53");
cpu_plan_test_tpcds!(cpu_tpcds_q54, "q54");
cpu_plan_test_tpcds!(cpu_tpcds_q55, "q55");
cpu_plan_test_tpcds!(cpu_tpcds_q56, "q56");
cpu_plan_test_tpcds!(cpu_tpcds_q57, "q57");
cpu_plan_test_tpcds!(cpu_tpcds_q58, "q58");
cpu_plan_test_tpcds!(cpu_tpcds_q59, "q59");
cpu_plan_test_tpcds!(cpu_tpcds_q60, "q60");
cpu_plan_test_tpcds!(cpu_tpcds_q61, "q61");
cpu_plan_test_tpcds!(cpu_tpcds_q62, "q62");
cpu_plan_test_tpcds!(cpu_tpcds_q63, "q63");
cpu_plan_test_tpcds!(cpu_tpcds_q64, "q64");
cpu_plan_test_tpcds!(cpu_tpcds_q65, "q65");
cpu_plan_test_tpcds!(cpu_tpcds_q66, "q66");
cpu_plan_test_tpcds!(cpu_tpcds_q67, "q67");
cpu_plan_test_tpcds!(cpu_tpcds_q68, "q68");
cpu_plan_test_tpcds!(cpu_tpcds_q69, "q69");
// q70: skipped (GROUPING() — same as query_plan_test)
cpu_plan_test_tpcds!(cpu_tpcds_q71, "q71");
// q72: skipped (Date32 + Int64 — same as query_plan_test)
cpu_plan_test_tpcds!(cpu_tpcds_q73, "q73");
cpu_plan_test_tpcds!(cpu_tpcds_q74, "q74");
cpu_plan_test_tpcds!(cpu_tpcds_q75, "q75");
cpu_plan_test_tpcds!(cpu_tpcds_q76, "q76");
cpu_plan_test_tpcds!(cpu_tpcds_q77, "q77");
cpu_plan_test_tpcds!(cpu_tpcds_q78, "q78");
cpu_plan_test_tpcds!(cpu_tpcds_q79, "q79");
cpu_plan_test_tpcds!(cpu_tpcds_q80, "q80");
cpu_plan_test_tpcds!(cpu_tpcds_q81, "q81");
cpu_plan_test_tpcds!(cpu_tpcds_q82, "q82");
cpu_plan_test_tpcds!(cpu_tpcds_q83, "q83");
cpu_plan_test_tpcds!(cpu_tpcds_q84, "q84");
cpu_plan_test_tpcds!(cpu_tpcds_q85, "q85");
// q86: skipped (GROUPING() — same as query_plan_test)
cpu_plan_test_tpcds!(cpu_tpcds_q87, "q87");
cpu_plan_test_tpcds!(cpu_tpcds_q88, "q88");
cpu_plan_test_tpcds!(cpu_tpcds_q89, "q89");
cpu_plan_test_tpcds!(cpu_tpcds_q90, "q90");
cpu_plan_test_tpcds!(cpu_tpcds_q91, "q91");
cpu_plan_test_tpcds!(cpu_tpcds_q92, "q92");
cpu_plan_test_tpcds!(cpu_tpcds_q93, "q93");
cpu_plan_test_tpcds!(cpu_tpcds_q94, "q94");
cpu_plan_test_tpcds!(cpu_tpcds_q95, "q95");
cpu_plan_test_tpcds!(cpu_tpcds_q96, "q96");
cpu_plan_test_tpcds!(cpu_tpcds_q97, "q97");
cpu_plan_test_tpcds!(cpu_tpcds_q98, "q98");
cpu_plan_test_tpcds!(cpu_tpcds_q99, "q99");
